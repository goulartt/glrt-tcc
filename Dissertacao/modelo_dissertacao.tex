...
\titulo{Modelo de Refatoração de Arquitetura Monolítica para uma Arquitetura Baseada em Microsserviços} % titulo do trabalho em português
\title{Monolithic Architecture Refactoring Model for a Microservice Based Architecture} % titulo do trabalho em inglês
\autor{João Victor Goulart de Almeida} % autor do trabalho
\cita{ALMEIDA, João Victor Goulart} % sobrenome (maiúsculas), nome do autor do trabalho

\palavraschave{Monólito. Microsserviços. Refatoração} % palavras-chave do trabalho - Devem ser inseridas de 3 a 5 palavras chave
